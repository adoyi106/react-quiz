          ...
          const question = state.questions.at(state.index)
            ...
            case "nextQuestion":
              ...
              case "finish":
                ...
                case "restart":
                  return {...state, status: "ready", questions: state.questions}
                  case "tick":
...
export default function App (){
 ...
 console.log(maxPossiblePoints)
  ...
  return <div className="app">
   ...
   {status === "finished" && <FinishingScreen points={points} maxPossiblePoints={maxPossiblePoints} highscore={highscore} dispatch={dispatch}/>}
